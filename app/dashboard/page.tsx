...
import { ArrowRight, BarChart2, Database, Activity, Bitcoin, Globe, ChevronDown, RefreshCw, Grid, LayoutGrid } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const [isAuthenticated, setIsAuthenticated] = useState(false); // Added for authentication
  ...
  const navItems = [
    ...
    },
    {
      ...
      color: panelColors['3dmodel'].primary
    }
  ];
  ...
  const renderPanelContent = (panel: PanelType, compact: boolean = false) => {
    switch (panel) {
      ...
      case '3dmodel':
        return (
          <div className="bg-[#0D1B2A]/80 backdrop-blur-md rounded-xl border border-gray-800 overflow-hidden shadow-lg h-full">
            ...
            <div className="p-4 flex items-center justify-center" style={{ height: compact ? '300px' : '500px' }}>
              <BitcoinModel key={`model-${refreshCount}`} />
            </div>
          </div>
        );
      default:
  ...
  // Main dashboard view
  return (
    <main className="min-h-screen bg-[#0D1B2A] dark:bg-[#121212] relative overflow-hidden">
      <div className={!isAuthenticated ? 'filter blur-sm' : ''}>
          ...
          {!isLoaded && (
            ...
            >
              <div className="text-center">
                <BitcoinModel height={100} width={100} />
        ...
        {/* Dashboard header */}
        <header className="sticky top-0 z-40 backdrop-blur-md bg-[#0D1B2A]/70 border-b border-gray-800">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-2">
                <h1 className="text-white text-xl font-bold hidden md:block">Bitcoin NetInsights</h1>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-gray-400 text-xs hidden md:flex items-center">
                ...
                <button
                  ...
                  className="p-2 rounded-lg bg-gray-800/50 hover:bg-gray-700/50 text-gray-300 transition-colors flex items-center gap-2"
                >
                  {viewMode === 'tabbed' ? (
                    <>
                      <LayoutGrid size={16} />
                ...
                <button
                  onClick={handleRefresh}
                  className="md:hidden p-2 rounded-lg bg-gray-800/50 hover:bg-gray-700/50 text-gray-300 transition-colors"
                  disabled={isRefreshing}
                >
              ...
              <div className="flex overflow-x-auto scrollbar-hide gap-2 pb-2">
                {navItems.map((item) => (
                  <button
                    ...
                    className={`flex items-center px-4 py-2 rounded-lg text-sm whitespace-nowrap transition-all duration-300 ${
                      activePanel === item.id
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {navItems.map((item) => (
                ...
                >
                  ...
                  <button
                    className="absolute bottom-3 right-3 p-2 rounded-full bg-gray-800/50 hover:bg-gray-700/70 text-gray-300 transition-colors"
        ...
        <AnimatePresence>
          {expandedPanel && (
            ...
            >
              <motion.div
                className="w-full max-w-5xl bg-[#0D1B2A]/90 rounded-xl overflow-hidden shadow-2xl"
              ...
              >
                <div className="p-4 border-b border-gray-800 flex items-center justify-between">
                  ...
                  <button
                    className="p-2 rounded-full bg-gray-800/50 hover:bg-gray-700/70 text-gray-300 transition-colors"
          ...
          <div className="bg-white p-8 rounded shadow-md w-96">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                type="button"
                onClick={() => setIsAuthenticated(true)} // Simulate signup
              >
                Sign Up
              </button>
            </div>
